...
/***/ "./client/src/components/SEOEditorHolder/SEOEditorHolder.js":
/*!******************************************************************!*\
  !*** ./client/src/components/SEOEditorHolder/SEOEditorHolder.js ***!
  \******************************************************************/
...
var _SEOInput = _interopRequireDefault(__webpack_require__(/*! ../SEOInputs/SEOInput */ "./client/src/components/SEOInputs/SEOInput.js"));
var _SEODropdown = _interopRequireDefault(__webpack_require__(/*! ../SEOInputs/SEODropdown */ "./client/src/components/SEOInputs/SEODropdown.js"));
var _SEOTextarea = _interopRequireDefault(__webpack_require__(/*! ../SEOInputs/SEOTextarea */ "./client/src/components/SEOInputs/SEOTextarea.js"));
var _SEORobotsFollow = _interopRequireDefault(__webpack_require__(/*! ../SEOInputs/SEORobotsFollow */ "./client/src/components/SEOInputs/SEORobotsFollow.js"));
var _SEORobotsIndex = _interopRequireDefault(__webpack_require__(/*! ../SEOInputs/SEORobotsIndex */ "./client/src/components/SEOInputs/SEORobotsIndex.js"));
var _SEOVarNames = _interopRequireDefault(__webpack_require__(/*! ../SEOInputs/SEOVarNames */ "./client/src/components/SEOInputs/SEOVarNames.js"));
...
var SEOEditorHolder = function (_React$Component) {
  ...
  var _super = _createSuper(SEOEditorHolder);
  function SEOEditorHolder(props) {
    ...
    _this.parseVariables = _this.parseVariables.bind(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(SEOEditorHolder, [{
    ...
    value: function getFieldName(name) {
      return "".concat(this.state.Name, "[").concat(name, "]");
    }
  }, {
    key: "openTab",
      ...
      if (str) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            str = str.split('{' + _key + '}').join(vars[_key]);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        className: "".concat(this.state.CurrentTab === 'seo' ? 'active' : ''),
        "data-href": "#seo",
        onClick: function onClick() {
          _this2.openTab('seo');
        }
      }, _react["default"].createElement("i", {
        className: "seo-rocket"
      }))), _react["default"].createElement("li", null, _react["default"].createElement("a", {
        className: "".concat(this.state.CurrentTab === 'facebook' ? 'active' : ''),
        "data-href": "#facebook",
        onClick: function onClick() {
          _this2.openTab('facebook');
        }
      }, _react["default"].createElement("i", {
        className: "seo-facebook-square"
      }))), _react["default"].createElement("li", null, _react["default"].createElement("a", {
        className: "".concat(this.state.CurrentTab === 'twitter' ? 'active' : ''),
        "data-href": "#twitter",
        onClick: function onClick() {
          _this2.openTab('twitter');
        }
      }, _react["default"].createElement("i", {
        className: "seo-twitter-square"
      }))), this.state.SettingsTab && _react["default"].createElement("li", null, _react["default"].createElement("a", {
        className: "".concat(this.state.CurrentTab === 'settings' ? 'active' : ''),
        "data-href": "#settings",
        onClick: function onClick() {
        ...
        className: "seo-tab ".concat(this.state.CurrentTab === 'seo' ? 'active' : ''),
        "data-tab": "seo"
      }, _react["default"].createElement("h3", {
        className: "seo-tab__title"
      }, "SEO Data"), _react["default"].createElement("div", {
        className: "seo-section"
      }, _react["default"].createElement("div", {
        className: "fields"
      }, _react["default"].createElement(_SEOVarNames["default"], {
        vars: this.state.Variables,
        onButtonClick: function onButtonClick(e, varName) {
          _this2.handleSEOVariableButtonClick(e, varName);
        }
      }), _react["default"].createElement(_SEOInput["default"], {
        label: "Focus Keyword",
      ...
      }), _react["default"].createElement(_SEODropdown["default"], {
      ...
      }), _react["default"].createElement(_SEOTextarea["default"], {
      ...
      }, _react["default"].createElement("h3", null, this.parseVariables(this.state.MetaTitle, true)), _react["default"].createElement("p", {
        className: "preview-link"
      }, this.parseVariables(this.state.Link)), _react["default"].createElement("p", {
        className: "preview-description"
      }, this.parseVariables(this.state.MetaDescription)))))), _react["default"].createElement("div", {
        className: "seo-tab ".concat(this.state.CurrentTab === 'facebook' ? 'active' : ''),
        "data-tab": "facebook"
      }, _react["default"].createElement("h3", {
        className: "seo-tab__title"
      }, "Facebook"), _react["default"].createElement("div", {
        className: "seo-section"
      }, _react["default"].createElement("div", {
        className: "fields"
      }, _react["default"].createElement(_SEOVarNames["default"], {
        ...
        type: "hidden",
        value: this.state.FacebookImageID,
        name: this.getFieldName('FacebookImageID')
      })), _react["default"].createElement("div", {
        className: "preview-holder"
      }, _react["default"].createElement("div", {
        ...
        style: {
          backgroundImage: "url(".concat(this.getFacebookImageURL(), ")")
        }
      }, this.state.EditableSEOImages && _react["default"].createElement("div", {
        className: "preview-card--actions"
      }, _react["default"].createElement("a", {
        className: "js-og-image-selector",
        onClick: function onClick() {
          _this2.openImageEditor('FacebookImage');
        }
      }, _react["default"].createElement("i", {
        className: "seo-pencil-square-o"
      }), " Change image"), this.state.FacebookImageURL && _react["default"].createElement("a", {
        className: "js-og-image-selector",
        onClick: function onClick() {
        ...
        className: "seo-trash"
      }), " Remove image"))), _react["default"].createElement("h3", null, this.parseVariables(this.state.FacebookTitle ? this.state.FacebookTitle : this.state.MetaTitle)), _react["default"].createElement("p", {
        className: "preview-description"
      }, this.parseVariables(this.state.FacebookDescription ? this.state.FacebookDescription : this.state.MetaDescription)), _react["default"].createElement("p", {
        className: "preview-link"
      }, this.parseVariables(this.state.HostName)))))), _react["default"].createElement("div", {
        className: "seo-tab ".concat(this.state.CurrentTab === 'twitter' ? 'active' : ''),
        "data-tab": "twitter"
      }, _react["default"].createElement("h3", {
        className: "seo-tab__title"
        ...
        type: "hidden",
        value: this.state.TwitterImageID,
        name: this.getFieldName('TwitterImageID')
      })), _react["default"].createElement("div", {
        className: "preview-holder"
      }, _react["default"].createElement("div", {
        ...
        className: "preview-card--image",
        style: {
          backgroundImage: "url(".concat(this.getTwitterImageURL(), ")")
        }
      }, this.state.EditableSEOImages && _react["default"].createElement("div", {
        className: "preview-card--actions"
      }, _react["default"].createElement("a", {
        ...
        className: "seo-pencil-square-o"
      }), " Change image"), this.state.TwitterImageURL && _react["default"].createElement("a", {
        className: "js-og-image-selector",
        onClick: function onClick() {
        ...
        className: "seo-trash"
      }), " Remove image"))), _react["default"].createElement("h3", null, this.parseVariables(this.state.TwitterTitle ? this.state.TwitterTitle : this.state.MetaTitle)), _react["default"].createElement("p", {
        className: "preview-description"
      }, this.parseVariables(this.state.TwitterDescription ? this.state.TwitterDescription : this.state.MetaDescription)), _react["default"].createElement("p", {
        className: "preview-link"
      }, this.parseVariables(this.state.HostName))))))), this.state.SettingsTab && _react["default"].createElement("div", {
        className: "seo-tab ".concat(this.state.CurrentTab === 'settings' ? 'active' : ''),
        "data-tab": "settings"
      }, _react["default"].createElement("h3", {
        className: "seo-tab__title"
      }, "Settings"), _react["default"].createElement(_SEORobotsIndex["default"], {
      ...
      }), _react["default"].createElement(_SEORobotsFollow["default"], {
      ...
      }), _react["default"].createElement("p", null, "The canonical URL that this page should point to, leave empty to default to permalink.", _react["default"].createElement("a", {
        href: "https://webmasters.googleblog.com/2009/12/handling-legitimate-cross-domain.html",
        target: "_blank"
      }, "Cross domain canonical"), " supported too."))));
    }
  }]);
  return SEOEditorHolder;
}(_react["default"].Component);
var _default = SEOEditorHolder;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/SEOInputs/SEODropdown.js":
/*!********************************************************!*\
  !*** ./client/src/components/SEOInputs/SEODropdown.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
__webpack_require__(/*! core-js/modules/es.object.get-prototype-of.js */ "./node_modules/core-js/modules/es.object.get-prototype-of.js");
var _react = _interopRequireDefault(__webpack_require__(/*! react */ "react"));
var _SEOInput2 = _interopRequireDefault(__webpack_require__(/*! ./SEOInput */ "./client/src/components/SEOInputs/SEOInput.js"));
var _SEOInputProgressbar = _interopRequireDefault(__webpack_require__(/*! ./SEOInputProgressbar */ "./client/src/components/SEOInputs/SEOInputProgressbar.js"));
var _SEOInputMessages = _interopRequireDefault(__webpack_require__(/*! ./SEOInputMessages */ "./client/src/components/SEOInputs/SEOInputMessages.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var SEODropdown = function (_SEOInput) {
  ...
  var _super = _createSuper(SEODropdown);
...
var _default = SEODropdown;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/SEOInputs/SEOInput.js":
/*!*****************************************************!*\
  !*** ./client/src/components/SEOInputs/SEOInput.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var SEOInput = function (_React$Component) {
  ...
  var _super = _createSuper(SEOInput);
  ...
  _createClass(SEOInput, [{
    ...
    value: function validateDuplicates(value, params) {
      ...
      this.duplicateCheckRequest = _jquery["default"].ajax({
        url: params.link,
        data: {
          Field: params.field,
          Needle: value
    ...
    value: function processValidateItem(type, value, params) {
      var val = this.props.parseVariables(value, this.props.name.indexOf('MetaTitle') >= 0);
      if (type == 'required') {
    ...
    value: function render() {
      return _react["default"].createElement("div", {
        className: "seo-input field"
      }, _react["default"].createElement("label", null, this.props.label), _react["default"].createElement("input", {
        type: "text",
        className: "text",
        name: this.props.name,
        ...
        onChange: this.onChange,
        onFocus: this.onFocus
      }), _react["default"].createElement(_SEOInputProgressbar["default"], null), _react["default"].createElement(_SEOInputMessages["default"], {
...
var _default = SEOInput;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/SEOInputs/SEOInputMessages.js":
/*!*************************************************************!*\
  !*** ./client/src/components/SEOInputs/SEOInputMessages.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var SEOInputMessages = function (_React$Component) {
  ...
  var _super = _createSuper(SEOInputMessages);
    ...
    value: function render() {
      return _react["default"].createElement("div", {
        ...
        return [_react["default"].createElement("p", {
          className: "message ".concat(message.type),
...
var _default = SEOInputMessages;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/SEOInputs/SEOInputProgressbar.js":
/*!****************************************************************!*\
  !*** ./client/src/components/SEOInputs/SEOInputProgressbar.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var SEOInputProgressbar = function (_React$Component) {
  ...
  var _super = _createSuper(SEOInputProgressbar);
...
var _default = SEOInputProgressbar;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/SEOInputs/SEORobotsFollow.js":
/*!************************************************************!*\
  !*** ./client/src/components/SEOInputs/SEORobotsFollow.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var SEORobotsFollow = function (_SEOInput) {
  ...
  var _super = _createSuper(SEORobotsFollow);
  ...
  _createClass(SEORobotsFollow, [{
    ...
    value: function render() {
      ...
      }, _react["default"].createElement("label", null, this.props.label), _react["default"].createElement("div", {
      ...
      }), "Follow"), _react["default"].createElement("label", null, _react["default"].createElement("input", {
        type: "radio",
        value: "no-follow",
        name: this.props.name,
        onClick: this.props.onChange,
...
var _default = SEORobotsFollow;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/SEOInputs/SEORobotsIndex.js":
/*!***********************************************************!*\
  !*** ./client/src/components/SEOInputs/SEORobotsIndex.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var SEORobotsIndex = function (_SEOInput) {
  ...
  var _super = _createSuper(SEORobotsIndex);
  ...
  _createClass(SEORobotsIndex, [{
    ...
    value: function render() {
      return _react["default"].createElement("div", {
        ...
        value: "index",
        selected: this.props.value === 'index'
      }, "index"), _react["default"].createElement("option", {
        value: "noindex",
        selected: this.props.value === 'noindex'
      }, "noindex")), _react["default"].createElement("p", null, "Note: This setting will be overridden by the site config's search engine visibility setting"));
    }
  }]);
  return SEORobotsIndex;
}(_SEOInput2["default"]);
var _default = SEORobotsIndex;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/SEOInputs/SEOTextarea.js":
/*!********************************************************!*\
  !*** ./client/src/components/SEOInputs/SEOTextarea.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var SEOTextarea = function (_SEOInput) {
  ...
  var _super = _createSuper(SEOTextarea);
  ...
  _createClass(SEOTextarea, [{
    ...
    value: function render() {
      return _react["default"].createElement("div", {
        className: "seo-input field"
      }, _react["default"].createElement("label", null, this.props.label), _react["default"].createElement("textarea", {
        className: "text",
        name: this.props.name,
        value: this.props.value,
        onChange: this.onChange,
...
var _default = SEOTextarea;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/SEOInputs/SEOVarNames.js":
/*!********************************************************!*\
  !*** ./client/src/components/SEOInputs/SEOVarNames.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var SEOVarNames = function (_React$Component) {
  ...
  var _super = _createSuper(SEOVarNames);
  ...
  _createClass(SEOVarNames, [{
    ...
    value: function render() {
      ...
      var _loop = function _loop() {
        ...
        vars.push(_react["default"].createElement("li", {
          key: key
        }, _react["default"].createElement("a", {
      ...
      for (var _i = 0, _Object$keys = Object.keys(this.props.vars); _i < _Object$keys.length; _i++) {
        _loop();
      }
      return _react["default"].createElement("div", {
        className: "seo-input field"
...
var _default = SEOVarNames;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/entwine/images-selector.js":
/*!***********************************************!*\
  !*** ./client/src/entwine/images-selector.js ***!
  \***********************************************/
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
var InjectableInsertMediaModal = (0, _Injector.loadComponent)(_InsertMediaModal["default"]);
_jquery["default"].entwine('ss', function ($) {
  $('#insert-seo-media-react__dialog-wrapper').entwine({
    ...
    _renderModal: function _renderModal(show) {
      ...
      var attrs = {};
      _reactDom["default"].render(_react["default"].createElement(InjectableInsertMediaModal, {
        title: false,
        type: "insert-media",
        isOpen: show,
...
var _react = _interopRequireDefault(__webpack_require__(/*! react */ "react"));
var _reactDom = _interopRequireDefault(__webpack_require__(/*! react-dom */ "react-dom"));
var _SEOEditorHolder = _interopRequireDefault(__webpack_require__(/*! ../components/SEOEditorHolder/SEOEditorHolder */ "./client/src/components/SEOEditorHolder/SEOEditorHolder.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
__webpack_require__(/*! ../entwine/images-selector */ "./client/src/entwine/images-selector.js");
_jquery["default"].entwine('ss', function ($) {
  $('.js-seo-editor:visible').entwine({
    ...
    refresh: function refresh() {
      ...
      _reactDom["default"].render(_react["default"].createElement(_SEOEditorHolder["default"], {
        link: link,
        name: name,
        seodata: seoData,
